      ...
      <div className="container text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="display-lg mb-8 text-white">
            Mahomed Irfan 
            <span className="block text-yellow-400">Akbur Ally</span>
          </h1>
            ...
            {socialLinks.map((social) => {
              ...
              return (
                <a
                  ...
                  className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center text-gray-400 hover:text-yellow-400 hover:bg-gray-700 transition-all duration-300 hover:scale-110"
          ...
          <div className="animate-bounce">
            <a href="#about" className="text-gray-500 hover:text-yellow-400 transition-colors">
              <ArrowDown size={24} />
            </a>
          </div>
        </div>
